...
- Make EARDBD load the configured report plugin instead of `dummy.so`. Thanks to [@CharlieThornton33](https://github.com/CharlieThornton33) for pointing it out.

## [7.4.1] - 2026-09-22

### Added

- New eard power monitor locking system.
- Locks unit tests added.

### Fixed

- Power monitor and powercap locks.
