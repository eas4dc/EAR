...
#define WF_APPLICATION        16

#define NODESENSORS_TYPE      1000
 ...
 * \param loops An array of loops signatures in the current node of the job. For this EAR version, expect to receive
 * only one.
...
/** This functions is a sugar to be called whatever you want in the EAR library, and lets you pass any kind of data as
 * bytes array.
 * \param id The calling process information.
 * \param type The identifier of the report call to be compatible with your plugin. This parameter was designed for
 * report plugins to filter the calls triggered for any other report plugin which also uses this funcion.
