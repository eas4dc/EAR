...
// Robert Wolford provided command: ipmitool raw 0x3a 0x32 4 2 0 0 0 --> High frequency command : Energy (J,mJ) and Time
// (sec,ms) lun=0x00 netfn=0x3a cmd=0x32 ipmitool raw 0x3a 0x32 4 2 0 0 0 COMMENT: Add 2 bytes to this format the
// response format is (LSB first): Byte 0-1: the index/location of FPGA FIFO. Byte 2-5: energy reading(J) Byte 6-7:
// energy reading(mJ) Byte 8-11: the second info for timestamp Byte 12-13: the millisecond info for timestamp
//
