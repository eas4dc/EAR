...
#ifndef METRICS_NODE_IPMI_INM_POWER_H
#define METRICS_NODE_IPMI_INM_POWER_H
...
#define INM_POWER_NETFN	      0x2E
#define INM_POWER_CMD					0xC8

typedef struct inm_power_data{
