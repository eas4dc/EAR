...
void print_format_lf(int WIDTH, double value, int float_precision) {  dprintf(out_format_fd, "%-*.*lf ", WIDTH, float_precision, value); }
void print_format_lu(int WIDTH, unsigned long value) {  dprintf(out_format_fd, "%-*lu ", WIDTH, value); }
void print_format_dc(int WIDTH, int32_t value) {   dprintf(out_format_fd, "%-*d ", WIDTH, value); }
void print_format_llu(int WIDTH, unsigned long long value) { dprintf(out_format_fd, "%-*llu ", WIDTH, value); }
void print_format_str(int WIDTH, char *value) {    dprintf(out_format_fd, "%-*s ", WIDTH, value); }
 ...
 */
#define print_format(WIDTH, value, ...) _Generic((value), \
...
default: print_format_str \
) (WIDTH, value __VA_OPT__(,) __VA_ARGS__)
