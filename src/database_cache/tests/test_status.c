...
int main(int argc, char *argv[])
{
    ...
    printf("Samples status: [%d,%u] [%d,%u] [%d,%u] [%d,%u] [%d,%u] [%d,%u] [%d,%u]\n", status.insert_states[0],
           status.samples_recv[0], status.insert_states[1], status.samples_recv[1], status.insert_states[2],
           status.samples_recv[2], status.insert_states[3], status.samples_recv[3], status.insert_states[4],
           status.samples_recv[4], status.insert_states[5], status.samples_recv[5], status.insert_states[6],
           status.samples_recv[6]);
