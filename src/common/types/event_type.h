...
#define GPU_ENERGY_SAVING      42
#define GPU_POWER_SAVING       43
#define GPU_PERF_PENALTY       44
#define GPU_ENERGY_SAVING_AVG  45
#define GPU_POWER_SAVING_AVG   46
#define GPU_PERF_PENALTY_AVG   47
