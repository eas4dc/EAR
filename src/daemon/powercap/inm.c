...
#define INM_ENABLE_POWERCAP_POLICY_CMD                                                                                 \
    "ipmitool -b 0x00 -t 0x2c nm policy add policy_id %u domain platform correction hard power %d  trig_lim 1000 "     \
    "stats 30 enable"
#define INM_ENABLE_POWERCAP_POLICY_CMD_SOFT                                                                            \
    "ipmitool -b 0x00 -t 0x2c nm policy add policy_id %u domain platform correction soft power %u trig_lim 1000 "      \
    "stats 5 enable"
