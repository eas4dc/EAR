...
void ear_mpif_Allgather(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
...
void ear_mpif_Allgatherv(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
                         MPI3_CONST MPI_Fint *recvcounts, MPI3_CONST MPI_Fint *displs, MPI_Fint *recvtype,
...
void ear_mpif_Allreduce(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
                        MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Allreduce...............");
...
void ear_mpif_Alltoall(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
                       MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Alltoall...............");
...
void ear_mpif_Alltoallv(MPI3_CONST void *sendbuf, MPI3_CONST MPI_Fint *sendcounts, MPI3_CONST MPI_Fint *sdispls,
                        MPI_Fint *sendtype, void *recvbuf, MPI3_CONST MPI_Fint *recvcounts,
...
void ear_mpif_Bsend(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                    MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Bsend...............");
...
void ear_mpif_Bsend_init(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
...
void ear_mpif_Cart_create(MPI_Fint *comm_old, MPI_Fint *ndims, MPI3_CONST MPI_Fint *dims, MPI3_CONST MPI_Fint *periods,
...
void ear_mpif_Comm_spawn(MPI3_CONST char *command, char *argv, MPI_Fint *maxprocs, MPI_Fint *info, MPI_Fint *root,
...
void ear_mpif_Comm_spawn_multiple(MPI_Fint *count, char *array_of_commands, char *array_of_argv,
                                  ...
                                  MPI_Fint *ierror)
{
    ...
    next_mpif.comm_spawn_multiple(count, array_of_commands, array_of_argv, array_of_maxprocs, array_of_info, root, comm,
...
void ear_mpif_File_read(MPI_File *fh, void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Status *status,
                        MPI_Fint *ierror)
{
    debug(">> F File_read...............");
...
void ear_mpif_File_read_all(MPI_File *fh, void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Status *status,
                            MPI_Fint *ierror)
{
...
void ear_mpif_File_read_at(MPI_File *fh, MPI_Offset *offset, void *buf, MPI_Fint *count, MPI_Fint *datatype,
...
void ear_mpif_File_read_at_all(MPI_File *fh, MPI_Offset *offset, void *buf, MPI_Fint *count, MPI_Fint *datatype,
                               MPI_Status *status, MPI_Fint *ierror)
{
...
void ear_mpif_File_write(MPI_File *fh, MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Status *status,
                         MPI_Fint *ierror)
{
    debug(">> F File_write...............");
...
void ear_mpif_File_write_all(MPI_File *fh, MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype,
                             MPI_Status *status, MPI_Fint *ierror)
{
...
void ear_mpif_File_write_at(MPI_File *fh, MPI_Offset *offset, MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype,
                            MPI_Status *status, MPI_Fint *ierror)
{
...
void ear_mpif_File_write_at_all(MPI_File *fh, MPI_Offset *offset, MPI3_CONST void *buf, MPI_Fint *count,
...
void ear_mpif_Gather(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
...
void ear_mpif_Gatherv(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
...
void ear_mpif_Get(MPI_Fint *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype, MPI_Fint *target_rank,
                  MPI_Fint *target_disp, MPI_Fint *target_count, MPI_Fint *target_datatype, MPI_Fint *win,
                  MPI_Fint *ierror)
{
    debug(">> F Get...............");
    before_mpi(Get, (p2i) origin_addr, 0);
    next_mpif.get(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count, target_datatype,
                  win, ierror);
    debug("<< F Get...............");
    after_mpi(Get);
}

void ear_mpif_Ibsend(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                     MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Ibsend...............");
...
void ear_mpif_Intercomm_create(MPI_Fint *local_comm, MPI_Fint *local_leader, MPI_Fint *peer_comm,
                               MPI_Fint *remote_leader, MPI_Fint *tag, MPI_Fint *newintercomm, MPI_Fint *ierror)
{
...
void ear_mpif_Iprobe(MPI_Fint *source, MPI_Fint *tag, MPI_Fint *comm, MPI_Fint *flag, MPI_Fint *status,
                     MPI_Fint *ierror)
{
    debug(">> F Iprobe...............");
...
void ear_mpif_Irecv(void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *source, MPI_Fint *tag, MPI_Fint *comm,
...
void ear_mpif_Irsend(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                     MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Irsend...............");
...
void ear_mpif_Isend(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                    MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Isend...............");
...
void ear_mpif_Issend(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                     MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Issend...............");
...
void ear_mpif_Put(MPI3_CONST void *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                  ...
                  MPI_Fint *win, MPI_Fint *ierror)
{
    ...
    next_mpif.put(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count, target_datatype,
                  win, ierror);
    debug("<< F Put...............");
    after_mpi(Put);
}

void ear_mpif_Recv(void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *source, MPI_Fint *tag, MPI_Fint *comm,
...
void ear_mpif_Recv_init(void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *source, MPI_Fint *tag, MPI_Fint *comm,
                        MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Recv_init...............");
...
void ear_mpif_Reduce(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
...
void ear_mpif_Reduce_scatter(MPI3_CONST void *sendbuf, void *recvbuf, MPI3_CONST MPI_Fint *recvcounts,
...
void ear_mpif_Rsend(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                    MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Rsend...............");
...
void ear_mpif_Rsend_init(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                         MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Rsend_init...............");
...
void ear_mpif_Scan(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
                   MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Scan...............");
...
void ear_mpif_Scatter(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
                      MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Scatter...............");
...
void ear_mpif_Scatterv(MPI3_CONST void *sendbuf, MPI3_CONST MPI_Fint *sendcounts, MPI3_CONST MPI_Fint *displs,
...
void ear_mpif_Send(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                   MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Send...............");
...
void ear_mpif_Send_init(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                        MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Send_init...............");
...
void ear_mpif_Sendrecv(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, MPI_Fint *dest,
                       ...
                       MPI_Fint *recvtag, MPI_Fint *comm, MPI_Fint *status, MPI_Fint *ierror)
{
    ...
    next_mpif.sendrecv(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype, source, recvtag, comm,
                       status, ierror);
    debug("<< F Sendrecv...............");
    after_mpi(Sendrecv);
}

void ear_mpif_Sendrecv_replace(void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *sendtag,
...
void ear_mpif_Ssend(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                    MPI_Fint *comm, MPI_Fint *ierror)
{
    debug(">> F Ssend...............");
...
void ear_mpif_Ssend_init(MPI3_CONST void *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                         MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Ssend_init...............");
...
void ear_mpif_Testall(MPI_Fint *count, MPI_Fint *array_of_requests, MPI_Fint *flag, MPI_Fint *array_of_statuses,
                      MPI_Fint *ierror)
{
    debug(">> F Testall...............");
...
void ear_mpif_Testany(MPI_Fint *count, MPI_Fint *array_of_requests, MPI_Fint *index, MPI_Fint *flag, MPI_Fint *status,
                      MPI_Fint *ierror)
{
    debug(">> F Testany...............");
...
void ear_mpif_Testsome(MPI_Fint *incount, MPI_Fint *array_of_requests, MPI_Fint *outcount, MPI_Fint *array_of_indices,
...
void ear_mpif_Waitsome(MPI_Fint *incount, MPI_Fint *array_of_requests, MPI_Fint *outcount, MPI_Fint *array_of_indices,
                       MPI_Fint *array_of_statuses, MPI_Fint *ierror)
{
    debug(">> F Waitsome...............");
...
void ear_mpif_Win_create(void *base, MPI_Aint *size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm, MPI_Fint *win,
                         MPI_Fint *ierror)
{
    debug(">> F Win_create...............");
...
// #if MPI_VERSION >= 3
void ear_mpif_Iallgather(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
...
void ear_mpif_Iallgatherv(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
                          MPI3_CONST MPI_Fint *recvcount, MPI3_CONST MPI_Fint *displs, MPI_Fint *recvtype,
                          MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Iallgatherv...............");
...
void ear_mpif_Iallreduce(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
                         MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Iallreduce...............");
...
void ear_mpif_Ialltoall(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
                        MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Ialltoall...............");
...
void ear_mpif_Ialltoallv(MPI3_CONST void *sendbuf, MPI3_CONST MPI_Fint *sendcounts, MPI3_CONST MPI_Fint *sdispls,
                         ...
                         MPI_Fint *ierror)
{
    ...
    next_mpif.ialltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, request, comm,
                         ierror);
    debug("<< F Ialltoallv...............");
...
void ear_mpif_Ibcast(void *buffer, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *root, MPI_Fint *comm,
                     MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Ibcast...............");
...
void ear_mpif_Igather(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
...
void ear_mpif_Igatherv(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
                       MPI3_CONST MPI_Fint *recvcounts, MPI3_CONST MPI_Fint *displs, MPI_Fint *recvtype, MPI_Fint *root,
                       MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Igatherv...............");
    before_mpi(Igatherv, (p2i) sendbuf, (p2i) recvbuf);
    next_mpif.igatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, request,
                       ierror);
    debug("<< F Igatherv...............");
    after_mpi(Igatherv);
}

void ear_mpif_Ireduce(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
...
void ear_mpif_Ireduce_scatter(MPI3_CONST void *sendbuf, void *recvbuf, MPI3_CONST MPI_Fint *recvcounts,
...
void ear_mpif_Iscan(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
                    MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Iscan...............");
...
void ear_mpif_Iscatter(MPI3_CONST void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf,
                       MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm, MPI_Fint *request,
                       MPI_Fint *ierror)
{
    debug(">> F Iscatter...............");
...
void ear_mpif_Iscatterv(MPI3_CONST void *sendbuf, MPI3_CONST MPI_Fint *sendcounts, MPI3_CONST MPI_Fint *displs,
                        MPI_Fint *sendtype, void *recvbuf, MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root,
                        MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierror)
{
    debug(">> F Iscatterv...............");
    before_mpi(Iscatterv, (p2i) sendbuf, (p2i) recvbuf);
    next_mpif.iscatterv(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, request,
                        ierror);
    debug("<< F Iscatterv...............");
    after_mpi(Iscatterv);
}
