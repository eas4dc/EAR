...
void ear_mpif_Allgather(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
			...
			MPI_Fint * comm, MPI_Fint * ierror)
{
	...
	next_mpif.allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			    recvtype, comm, ierror);
	debug("<< F Allgather...............");
	after_mpi(Allgather);
}

void ear_mpif_Allgatherv(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
			 MPI_Fint * sendtype, void *recvbuf,
			 ...
			 MPI_Fint * comm, MPI_Fint * ierror)
{
	...
	next_mpif.allgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
			     displs, recvtype, comm, ierror);
	debug("<< F Allgatherv...............");
	after_mpi(Allgatherv);
}

void ear_mpif_Allreduce(MPI3_CONST void *sendbuf, void *recvbuf,
			MPI_Fint * count, MPI_Fint * datatype, MPI_Fint * op,
			MPI_Fint * comm, MPI_Fint * ierror)
{
	debug(">> F Allreduce...............");
	before_mpi(Allreduce, (p2i) sendbuf, (p2i) recvbuf);
	next_mpif.allreduce(sendbuf, recvbuf, count, datatype, op, comm,
			    ierror);
	debug("<< F Allreduce...............");
	after_mpi(Allreduce);
}

void ear_mpif_Alltoall(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		       ...
		       MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * ierror)
{
	...
	next_mpif.alltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			   recvtype, comm, ierror);
	debug("<< F Alltoall...............");
	after_mpi(Alltoall);
}

void ear_mpif_Alltoallv(MPI3_CONST void *sendbuf,
			...
			MPI_Fint * comm, MPI_Fint * ierror)
{
	...
	next_mpif.alltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf,
...
void ear_mpif_Bcast(void *buffer, MPI_Fint * count, MPI_Fint * datatype,
...
void ear_mpif_Bsend(MPI3_CONST void *buf, MPI_Fint * count, MPI_Fint * datatype,
...
void ear_mpif_Bsend_init(MPI3_CONST void *buf, MPI_Fint * count,
			 ...
			 MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	...
	next_mpif.bsend_init(buf, count, datatype, dest, tag, comm, request,
			     ierror);
	debug("<< F Bsend_init...............");
...
void ear_mpif_Cart_create(MPI_Fint * comm_old, MPI_Fint * ndims,
			  ...
			  MPI_Fint * comm_cart, MPI_Fint * ierror)
{
	...
	next_mpif.cart_create(comm_old, ndims, dims, periods, reorder,
			      comm_cart, ierror);
	debug("<< F Cart_create...............");
	after_mpi(Cart_create);
}

void ear_mpif_Cart_sub(MPI_Fint * comm, MPI3_CONST MPI_Fint * remain_dims,
...
void ear_mpif_Comm_create(MPI_Fint * comm, MPI_Fint * group, MPI_Fint * newcomm,
			  MPI_Fint * ierror)
{
	debug(">> F Comm_create...............");
...
void ear_mpif_Comm_spawn(MPI3_CONST char *command, char *argv,
			 MPI_Fint * maxprocs, MPI_Fint * info, MPI_Fint * root,
			 MPI_Fint * comm, MPI_Fint * intercomm,
			 MPI_Fint * array_of_errcodes, MPI_Fint * ierror)
{
	debug(">> F Comm_spawn...............");
	before_mpi(Comm_spawn, (p2i) command, 0);
	next_mpif.comm_spawn(command, argv, maxprocs, info, root, comm,
			     intercomm, array_of_errcodes, ierror);
	debug("<< F Comm_spawn...............");
	after_mpi(Comm_spawn);
}

void ear_mpif_Comm_spawn_multiple(MPI_Fint * count, char *array_of_commands,
				  char *array_of_argv,
				  ...
				  MPI_Fint * ierror)
{
	...
	next_mpif.comm_spawn_multiple(count, array_of_commands, array_of_argv,
...
void ear_mpif_Comm_split(MPI_Fint * comm, MPI_Fint * color, MPI_Fint * key,
...
void ear_mpif_File_read(MPI_File * fh, void *buf, MPI_Fint * count,
...
void ear_mpif_File_read_all(MPI_File * fh, void *buf, MPI_Fint * count,
			    MPI_Fint * datatype, MPI_Status * status,
			    MPI_Fint * ierror)
{
...
void ear_mpif_File_read_at(MPI_File * fh, MPI_Offset * offset, void *buf,
			   MPI_Fint * count, MPI_Fint * datatype,
			   MPI_Status * status, MPI_Fint * ierror)
{
	debug(">> F File_read_at...............");
	before_mpi(File_read_at, (p2i) buf, 0);
	next_mpif.file_read_at(fh, offset, buf, count, datatype, status,
			       ierror);
	debug("<< F File_read_at...............");
	after_mpi(File_read_at);
}

void ear_mpif_File_read_at_all(MPI_File * fh, MPI_Offset * offset, void *buf,
			       MPI_Fint * count, MPI_Fint * datatype,
			       MPI_Status * status, MPI_Fint * ierror)
{
	debug(">> F File_read_at_all...............");
	before_mpi(File_read_at_all, (p2i) buf, 0);
	next_mpif.file_read_at_all(fh, offset, buf, count, datatype, status,
				   ierror);
	debug("<< F File_read_at_all...............");
	after_mpi(File_read_at_all);
}

void ear_mpif_File_write(MPI_File * fh, MPI3_CONST void *buf, MPI_Fint * count,
			 MPI_Fint * datatype, MPI_Status * status,
			 MPI_Fint * ierror)
{
	debug(">> F File_write...............");
...
void ear_mpif_File_write_all(MPI_File * fh, MPI3_CONST void *buf,
			     MPI_Fint * count, MPI_Fint * datatype,
			     MPI_Status * status, MPI_Fint * ierror)
{
...
void ear_mpif_File_write_at(MPI_File * fh, MPI_Offset * offset,
			    ...
			    MPI_Fint * ierror)
{
	...
	next_mpif.file_write_at(fh, offset, buf, count, datatype, status,
				ierror);
	debug("<< F File_write_at...............");
	after_mpi(File_write_at);
}

void ear_mpif_File_write_at_all(MPI_File * fh, MPI_Offset * offset,
				MPI3_CONST void *buf, MPI_Fint * count,
				MPI_Fint * datatype, MPI_Status * status,
				MPI_Fint * ierror)
{
	...
	next_mpif.file_write_at_all(fh, offset, buf, count, datatype, status,
				    ierror);
	debug("<< F File_write_at_all...............");
...
void ear_mpif_Gather(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		     MPI_Fint * sendtype, void *recvbuf, MPI_Fint * recvcount,
		     ...
		     MPI_Fint * ierror)
{
	...
	next_mpif.gather(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			 recvtype, root, comm, ierror);
	debug("<< F Gather...............");
	after_mpi(Gather);
}

void ear_mpif_Gatherv(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		      MPI_Fint * sendtype, void *recvbuf,
		      MPI3_CONST MPI_Fint * recvcounts,
		      MPI3_CONST MPI_Fint * displs, MPI_Fint * recvtype,
		      MPI_Fint * root, MPI_Fint * comm, MPI_Fint * ierror)
{
	...
	next_mpif.gatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
			  displs, recvtype, root, comm, ierror);
	debug("<< F Gatherv...............");
	after_mpi(Gatherv);
}

void ear_mpif_Get(MPI_Fint * origin_addr, MPI_Fint * origin_count,
		  ...
		  MPI_Fint * target_datatype, MPI_Fint * win, MPI_Fint * ierror)
{
	...
	next_mpif.get(origin_addr, origin_count, origin_datatype, target_rank,
		      target_disp, target_count, target_datatype, win, ierror);
	debug("<< F Get...............");
	after_mpi(Get);
}

void ear_mpif_Ibsend(MPI3_CONST void *buf, MPI_Fint * count,
		     MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag,
		     MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Ibsend...............");
	before_mpi(Ibsend, (p2i) buf, (p2i) dest);
	next_mpif.ibsend(buf, count, datatype, dest, tag, comm, request,
			 ierror);
	debug("<< F Ibsend...............");
	after_mpi(Ibsend);
}
...
void ear_mpif_Init_thread(MPI_Fint * required, MPI_Fint * provided,
			  MPI_Fint * ierror)
{
	debug(">> F Init_thread...............");
	before_init();
...
void ear_mpif_Intercomm_create(MPI_Fint * local_comm, MPI_Fint * local_leader,
			       ...
			       MPI_Fint * ierror)
{
	...
	next_mpif.intercomm_create(local_comm, local_leader, peer_comm,
				   remote_leader, tag, newintercomm, ierror);
	debug("<< F Intercomm_create...............");
	after_mpi(Intercomm_create);
}

void ear_mpif_Intercomm_merge(MPI_Fint * intercomm, MPI_Fint * high,
...
void ear_mpif_Iprobe(MPI_Fint * source, MPI_Fint * tag, MPI_Fint * comm,
...
void ear_mpif_Irecv(void *buf, MPI_Fint * count, MPI_Fint * datatype,
		    MPI_Fint * source, MPI_Fint * tag, MPI_Fint * comm,
		    MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Irecv...............");
	before_mpi(Irecv, (p2i) buf, (p2i) source);
	next_mpif.irecv(buf, count, datatype, source, tag, comm, request,
			ierror);
	debug("<< F Irecv...............");
	after_mpi(Irecv);
}

void ear_mpif_Irsend(MPI3_CONST void *buf, MPI_Fint * count,
		     MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag,
		     MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Irsend...............");
	before_mpi(Irsend, (p2i) buf, (p2i) dest);
	next_mpif.irsend(buf, count, datatype, dest, tag, comm, request,
			 ierror);
	debug("<< F Irsend...............");
	after_mpi(Irsend);
}

void ear_mpif_Isend(MPI3_CONST void *buf, MPI_Fint * count, MPI_Fint * datatype,
		    MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm,
		    MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Isend...............");
...
void ear_mpif_Issend(MPI3_CONST void *buf, MPI_Fint * count,
		     MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag,
		     MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Issend...............");
	before_mpi(Issend, (p2i) buf, (p2i) dest);
	next_mpif.issend(buf, count, datatype, dest, tag, comm, request,
			 ierror);
	debug("<< F Issend...............");
	after_mpi(Issend);
}

void ear_mpif_Probe(MPI_Fint * source, MPI_Fint * tag, MPI_Fint * comm,
...
void ear_mpif_Put(MPI3_CONST void *origin_addr, MPI_Fint * origin_count,
		  MPI_Fint * origin_datatype, MPI_Fint * target_rank,
		  MPI_Fint * target_disp, MPI_Fint * target_count,
		  MPI_Fint * target_datatype, MPI_Fint * win, MPI_Fint * ierror)
{
	...
	next_mpif.put(origin_addr, origin_count, origin_datatype, target_rank,
		      target_disp, target_count, target_datatype, win, ierror);
	debug("<< F Put...............");
	after_mpi(Put);
}

void ear_mpif_Recv(void *buf, MPI_Fint * count, MPI_Fint * datatype,
		   MPI_Fint * source, MPI_Fint * tag, MPI_Fint * comm,
		   MPI_Fint * status, MPI_Fint * ierror)
{
	debug(">> F Recv...............");
...
void ear_mpif_Recv_init(void *buf, MPI_Fint * count, MPI_Fint * datatype,
			MPI_Fint * source, MPI_Fint * tag, MPI_Fint * comm,
			MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Recv_init...............");
	before_mpi(Recv_init, (p2i) buf, (p2i) source);
	next_mpif.recv_init(buf, count, datatype, source, tag, comm, request,
			    ierror);
	debug("<< F Recv_init...............");
	after_mpi(Recv_init);
}

void ear_mpif_Reduce(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint * count,
		     MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * root,
		     MPI_Fint * comm, MPI_Fint * ierror)
{
	debug(">> F Reduce...............");
	before_mpi(Reduce, (p2i) sendbuf, (p2i) recvbuf);
	next_mpif.reduce(sendbuf, recvbuf, count, datatype, op, root, comm,
			 ierror);
	debug("<< F Reduce...............");
	after_mpi(Reduce);
}

void ear_mpif_Reduce_scatter(MPI3_CONST void *sendbuf, void *recvbuf,
			     MPI3_CONST MPI_Fint * recvcounts,
			     ...
			     MPI_Fint * comm, MPI_Fint * ierror)
{
	...
	next_mpif.reduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op,
				 comm, ierror);
	debug("<< F Reduce_scatter...............");
...
void ear_mpif_Request_get_status(MPI_Fint * request, int *flag,
				 MPI_Fint * status, MPI_Fint * ierror)
{
...
void ear_mpif_Rsend(MPI3_CONST void *buf, MPI_Fint * count, MPI_Fint * datatype,
		    MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm,
		    MPI_Fint * ierror)
{
	debug(">> F Rsend...............");
...
void ear_mpif_Rsend_init(MPI3_CONST void *buf, MPI_Fint * count,
			 MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag,
			 MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Rsend_init...............");
	before_mpi(Rsend_init, (p2i) buf, (p2i) dest);
	next_mpif.rsend_init(buf, count, datatype, dest, tag, comm, request,
			     ierror);
	debug("<< F Rsend_init...............");
	after_mpi(Rsend_init);
}

void ear_mpif_Scan(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint * count,
...
void ear_mpif_Scatter(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		      MPI_Fint * sendtype, void *recvbuf, MPI_Fint * recvcount,
		      MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm,
		      MPI_Fint * ierror)
{
	...
	next_mpif.scatter(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			  recvtype, root, comm, ierror);
	debug("<< F Scatter...............");
	after_mpi(Scatter);
}

void ear_mpif_Scatterv(MPI3_CONST void *sendbuf,
		       MPI3_CONST MPI_Fint * sendcounts,
		       ...
		       MPI_Fint * root, MPI_Fint * comm, MPI_Fint * ierror)
{
	...
	next_mpif.scatterv(sendbuf, sendcounts, displs, sendtype, recvbuf,
			   recvcount, recvtype, root, comm, ierror);
	debug("<< F Scatterv...............");
	after_mpi(Scatterv);
}

void ear_mpif_Send(MPI3_CONST void *buf, MPI_Fint * count, MPI_Fint * datatype,
		   MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm,
		   MPI_Fint * ierror)
{
	debug(">> F Send...............");
...
void ear_mpif_Send_init(MPI3_CONST void *buf, MPI_Fint * count,
			MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag,
			MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Send_init...............");
	before_mpi(Send_init, (p2i) buf, (p2i) dest);
	next_mpif.send_init(buf, count, datatype, dest, tag, comm, request,
			    ierror);
	debug("<< F Send_init...............");
	after_mpi(Send_init);
}

void ear_mpif_Sendrecv(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		       ...
		       MPI_Fint * status, MPI_Fint * ierror)
{
	...
	next_mpif.sendrecv(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf,
...
void ear_mpif_Sendrecv_replace(void *buf, MPI_Fint * count, MPI_Fint * datatype,
			       ...
			       MPI_Fint * ierror)
{
	...
	next_mpif.sendrecv_replace(buf, count, datatype, dest, sendtag, source,
				   recvtag, comm, status, ierror);
	debug("<< F Sendrecv_replace...............");
	after_mpi(Sendrecv_replace);
}

void ear_mpif_Ssend(MPI3_CONST void *buf, MPI_Fint * count, MPI_Fint * datatype,
		    MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm,
		    MPI_Fint * ierror)
{
	debug(">> F Ssend...............");
...
void ear_mpif_Ssend_init(MPI3_CONST void *buf, MPI_Fint * count,
			 MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag,
			 MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Ssend_init...............");
	before_mpi(Ssend_init, (p2i) buf, (p2i) dest);
	next_mpif.ssend_init(buf, count, datatype, dest, tag, comm, request,
			     ierror);
	debug("<< F Ssend_init...............");
...
void ear_mpif_Startall(MPI_Fint * count, MPI_Fint * array_of_requests,
		       MPI_Fint * ierror)
{
	debug(">> F Startall...............");
...
void ear_mpif_Test(MPI_Fint * request, MPI_Fint * flag, MPI_Fint * status,
		   MPI_Fint * ierror)
{
	debug(">> F Test...............");
...
void ear_mpif_Testall(MPI_Fint * count, MPI_Fint * array_of_requests,
		      MPI_Fint * flag, MPI_Fint * array_of_statuses,
		      MPI_Fint * ierror)
{
	debug(">> F Testall...............");
	before_mpi(Testall, 0, 0);
	next_mpif.testall(count, array_of_requests, flag, array_of_statuses,
			  ierror);
	debug("<< F Testall...............");
	after_mpi(Testall);
}

void ear_mpif_Testany(MPI_Fint * count, MPI_Fint * array_of_requests,
		      MPI_Fint * index, MPI_Fint * flag, MPI_Fint * status,
		      MPI_Fint * ierror)
{
	debug(">> F Testany...............");
	before_mpi(Testany, 0, 0);
	next_mpif.testany(count, array_of_requests, index, flag, status,
			  ierror);
	debug("<< F Testany...............");
	after_mpi(Testany);
}

void ear_mpif_Testsome(MPI_Fint * incount, MPI_Fint * array_of_requests,
		       MPI_Fint * outcount, MPI_Fint * array_of_indices,
		       MPI_Fint * array_of_statuses, MPI_Fint * ierror)
{
	debug(">> F Testsome...............");
	before_mpi(Testsome, 0, 0);
	next_mpif.testsome(incount, array_of_requests, outcount,
...
void ear_mpif_Waitall(MPI_Fint * count, MPI_Fint * array_of_requests,
		      MPI_Fint * array_of_statuses, MPI_Fint * ierror)
{
	debug(">> F Waitall...............");
...
void ear_mpif_Waitany(MPI_Fint * count, MPI_Fint * requests, MPI_Fint * index,
		      MPI_Fint * status, MPI_Fint * ierror)
{
	debug(">> F Waitany...............");
...
void ear_mpif_Waitsome(MPI_Fint * incount, MPI_Fint * array_of_requests,
		       MPI_Fint * outcount, MPI_Fint * array_of_indices,
		       MPI_Fint * array_of_statuses, MPI_Fint * ierror)
{
	debug(">> F Waitsome...............");
	before_mpi(Waitsome, 0, 0);
	next_mpif.waitsome(incount, array_of_requests, outcount,
			   array_of_indices, array_of_statuses, ierror);
	debug("<< F Waitsome...............");
	after_mpi(Waitsome);
}
...
void ear_mpif_Win_create(void *base, MPI_Aint * size, MPI_Fint * disp_unit,
...
void ear_mpif_Win_post(MPI_Fint * group, MPI_Fint * assert, MPI_Fint * win,
		       MPI_Fint * ierror)
{
	debug(">> F Win_post...............");
...
void ear_mpif_Win_start(MPI_Fint * group, MPI_Fint * assert, MPI_Fint * win,
			MPI_Fint * ierror)
{
	debug(">> F Win_start...............");
...
//#if MPI_VERSION >= 3
void ear_mpif_Iallgather(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
			 MPI_Fint * sendtype, void *recvbuf,
			 MPI_Fint * recvcount, MPI_Fint * recvtype,
			 MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	...
	next_mpif.iallgather(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			     recvtype, comm, request, ierror);
	debug("<< F Iallgather...............");
	after_mpi(Iallgather);
}

void ear_mpif_Iallgatherv(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
			  MPI_Fint * sendtype, void *recvbuf,
			  ...
			  MPI_Fint * ierror)
{
	...
	next_mpif.iallgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			      displs, recvtype, comm, request, ierror);
	debug("<< F Iallgatherv...............");
	after_mpi(Iallgatherv);
}

void ear_mpif_Iallreduce(MPI3_CONST void *sendbuf, void *recvbuf,
			 MPI_Fint * count, MPI_Fint * datatype, MPI_Fint * op,
			 MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Iallreduce...............");
	before_mpi(Iallreduce, (p2i) sendbuf, (p2i) recvbuf);
	next_mpif.iallreduce(sendbuf, recvbuf, count, datatype, op, comm,
			     request, ierror);
	debug("<< F Iallreduce...............");
	after_mpi(Iallreduce);
}

void ear_mpif_Ialltoall(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
			MPI_Fint * sendtype, void *recvbuf,
			MPI_Fint * recvcount, MPI_Fint * recvtype,
			MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	...
	next_mpif.ialltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			    recvtype, comm, request, ierror);
	debug("<< F Ialltoall...............");
	after_mpi(Ialltoall);
}

void ear_mpif_Ialltoallv(MPI3_CONST void *sendbuf,
			 MPI3_CONST MPI_Fint * sendcounts,
			 MPI3_CONST MPI_Fint * sdispls, MPI_Fint * sendtype,
			 MPI_Fint * recvbuf, MPI3_CONST MPI_Fint * recvcounts,
			 MPI3_CONST MPI_Fint * rdispls, MPI_Fint * recvtype,
			 MPI_Fint * request, MPI_Fint * comm, MPI_Fint * ierror)
{
	debug(">> F Ialltoallv...............");
	before_mpi(Ialltoallv, (p2i) sendbuf, (p2i) recvbuf);
	next_mpif.ialltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf,
			     recvcounts, rdispls, recvtype, request, comm,
			     ierror);
	debug("<< F Ialltoallv...............");
...
void ear_mpif_Ibcast(void *buffer, MPI_Fint * count, MPI_Fint * datatype,
...
void ear_mpif_Igather(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		      MPI_Fint * sendtype, void *recvbuf, MPI_Fint * recvcount,
		      MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm,
		      MPI_Fint * request, MPI_Fint * ierror)
{
	...
	next_mpif.igather(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			  recvtype, root, comm, request, ierror);
	debug("<< F Igather...............");
	after_mpi(Igather);
}

void ear_mpif_Igatherv(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		       MPI_Fint * sendtype, void *recvbuf,
		       MPI3_CONST MPI_Fint * recvcounts,
		       MPI3_CONST MPI_Fint * displs, MPI_Fint * recvtype,
		       MPI_Fint * root, MPI_Fint * comm, MPI_Fint * request,
		       MPI_Fint * ierror)
{
	...
	next_mpif.igatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
			   displs, recvtype, root, comm, request, ierror);
	debug("<< F Igatherv...............");
	after_mpi(Igatherv);
}

void ear_mpif_Ireduce(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint * count,
		      MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * root,
		      MPI_Fint * comm, MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Ireduce...............");
	before_mpi(Ireduce, (p2i) sendbuf, (p2i) recvbuf);
	next_mpif.ireduce(sendbuf, recvbuf, count, datatype, op, root, comm,
			  request, ierror);
	debug("<< F Ireduce...............");
	after_mpi(Ireduce);
}

void ear_mpif_Ireduce_scatter(MPI3_CONST void *sendbuf, void *recvbuf,
			      MPI3_CONST MPI_Fint * recvcounts,
			      MPI_Fint * datatype, MPI_Fint * op,
			      MPI_Fint * comm, MPI_Fint * request,
			      MPI_Fint * ierror)
{
	...
	next_mpif.ireduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op,
				  comm, request, ierror);
	debug("<< F Ireduce_scatter...............");
	after_mpi(Ireduce_scatter);
}

void ear_mpif_Iscan(MPI3_CONST void *sendbuf, void *recvbuf, MPI_Fint * count,
		    MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
		    MPI_Fint * request, MPI_Fint * ierror)
{
	debug(">> F Iscan...............");
	before_mpi(Iscan, (p2i) sendbuf, (p2i) recvbuf);
	next_mpif.iscan(sendbuf, recvbuf, count, datatype, op, comm, request,
			ierror);
	debug("<< F Iscan...............");
	after_mpi(Iscan);
}

void ear_mpif_Iscatter(MPI3_CONST void *sendbuf, MPI_Fint * sendcount,
		       MPI_Fint * sendtype, void *recvbuf, MPI_Fint * recvcount,
		       MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm,
		       MPI_Fint * request, MPI_Fint * ierror)
{
	...
	next_mpif.iscatter(sendbuf, sendcount, sendtype, recvbuf, recvcount,
			   recvtype, root, comm, request, ierror);
	debug("<< F Iscatter...............");
	after_mpi(Iscatter);
}

void ear_mpif_Iscatterv(MPI3_CONST void *sendbuf,
			MPI3_CONST MPI_Fint * sendcounts,
			MPI3_CONST MPI_Fint * displs, MPI_Fint * sendtype,
			...
			MPI_Fint * request, MPI_Fint * ierror)
{
	...
	next_mpif.iscatterv(sendbuf, sendcounts, displs, sendtype, recvbuf,
