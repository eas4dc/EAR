...
state_t dcgmi_lib_data_alloc(dcgmi_lib_t *dcgmi_lib_data, int set_count)
{
    ...
    if (dcgmi_lib_data) {
        ...
        if (dcgmi_lib_data->dcgmi_set_sizes && dcgmi_lib_data->dcgmi_event_ids && dcgmi_lib_data->dcgmi_event_ids_csv &&
            dcgmi_lib_data->gpuprof_read1 && dcgmi_lib_data->gpuprof_read2 && dcgmi_lib_data->gpuprof_diff &&
