...
COMPONENT_DISABLE="database_cache commands tools" make -f Makefile.nompi.$tag $2
COMPONENT_DISABLE="database_cache commands tools" make -f Makefile.nompi.$tag install
...
COMPONENT_DISABLE="database_cache commands tools" make -f Makefile.openmpi.$tag $2
COMPONENT_DISABLE="database_cache commands tools" make -f Makefile.openmpi.$tag earl.install
