...
my_cflags='-Wno-unused-command-line-argument -static-intel -Wall -g -Rno-debug-disables-optimization -Wno-empty-body -msse4.1  -msse4.2 -msse3 -mavx512dq -mavx512f -mavx'
...
# With gcc
my_cflags='-msse4.1  -msse4.2 -msse3 -mavx512dq -mavx512f -mavx -Wall'
